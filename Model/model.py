...
from dualChannelRNN import rnnCell_dualNet_ as rnnCell_
...
def augment_model_trainability(model):
    '''
    take an existing model generated from the function above and make more trainable weights if you want
    '''
